...
def order():
    if request.method == "GET":
        ...
        #Есть 1. превірити чи автентифікований користувач що надсилає запит
        #Есть 2. зібрати усі необхідні відомості для формування замовлення іх форми запиту
        #Есть 3. додати замовлення у список orders
        #еСТЬ 4. перенапривити коистувача назад на сторінку /order
        username = request.cookies["username"]
